...
// IO - v2026-1_0.0 - 20 / 05 / 2026
// Author: lucas Coelho Diniz
...
#include <limits>         // para limites de tipos
#include <iomanip>        // para formatacao de saida
...
typedef unsigned char  byte;        // definir byte  =  8 bits
typedef unsigned char* bits;        // definir arranjo de bits
...
void IO_id ( std::string text )
{
    ...
    std::cout << "Autor: lucas Coelho Diniz";
