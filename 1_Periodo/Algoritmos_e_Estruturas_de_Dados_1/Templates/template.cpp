...
#include <time.h>      // para medir tempo
                       // com  Programacao Orientada a Objetos
#include <iostream>    // para entradas e saida em   streams
#include <iomanip>     // para formatacoes      em   streams
#include <fstream>     // para arquivos
#include <sstream>     // para manipular string como stream
#include <string>      // para manipular string (POO)
...
char * function (const char * parameter)
{
  char * result = NULL;
  //
  return ( result );
...
void procedure (const char parameter [ ])
{
  //
}
...
void procedure (int parameter [ ][MAX])
{
  //
}
...
void procedure (struct s parameter)
{
  //
}
